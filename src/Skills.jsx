    ...
    return(
        ...
        <main className="">
            ...
            <section className="text-5xl flex-wrap flex flex-row justify-center gap-4 lg-p-2 mb-12">
                ...
                <div>
                    <h1 className='text-teal-700 dark:text-sky-300 items-center hover:cursor-pointer hover:bg-teal-700 hover:text-white hover:dark:bg-sky-300 hover:dark:text-black rounded-full p-2 hover:shadow-xl hover:shadow-teal-600'><SiAngular /></h1>
                </div>
